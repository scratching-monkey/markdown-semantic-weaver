...
suite('TermExtractor', () => {
    it('should extract terms from content blocks', () => {
        ...
        const mockBlocks: ContentBlock[] = [
            { id: '1', blockType: 'paragraph', rawContent: 'A relational database is defined as a type of database that stores and provides access to data points that are related to one another.', metadata: { source: 'test.md', level: 1, heading: 'Introduction' } },
            { id: '2', blockType: 'paragraph', rawContent: 'The term relational database was first used by E.F. Codd at IBM in 1970.', metadata: { source: 'test.md', level: 1, heading: 'Introduction' } }
        ];
